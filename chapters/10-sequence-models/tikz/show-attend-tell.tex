\begin{tikzpicture}[
    ...
    \foreach \i/\a in {0/1,1/2,2/3} {
        \node[coordinate] (alpha\a) at ({2+\i*2},2.0) {};
        \pic at (alpha\a) {grid3};
    ...
    % ---- context vector: weighted combination of feature map + attention ----
    \draw[arr, dlblue] (fmap) to[out=-60,in=160] (z1.west);
    \draw[arr, dlblue] (alpha1) to[out=-60,in=100] (z1.north);
    \draw[arr, dlblue] (fmap) to[out=-70,in=180] (z2.west);
    \draw[arr, dlblue] (alpha2) to[out=-60,in=100] (z2.north);
