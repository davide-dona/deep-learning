...
where $\vct{v}_i$ and $\vct{t}_i$ are the embeddings of the $i$-th image and text pair, $\simop$ is the cosine similarity function, and $\tau$ is a \textbf{temperature} hyperparameter that controls the sharpness of the distribution.
