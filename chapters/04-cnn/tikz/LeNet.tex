...
\node[s=3cm, fill=tensorfill] (0) {};
%-----
% \node[s=2.5cm, fill=tensorfill, right=1cm of 0, yshift=1cm] (a0) {};
% \node[s=2.5cm, fill=tensorfillalt] (a1) at ($(a0)+(.25,-.25)$) {};
\begin{scope}[xshift=3.5cm, yshift=.6cm]
\foreach \i in {0,...,5} {
        \ifodd\i
            \node[s=2.5cm, fill=tensorfillalt] (a\i) at (.25*\i,-.25*\i) {};
        \else
            \node[s=2.5cm, fill=tensorfill] (a\i) at (.25*\i,-.25*\i) {};
        \fi
    }
\end{scope}
%----------------------------------------
...
\foreach \i in {0,...,5} {
        \ifodd\i
            \node[s=1.5cm, fill=tensorfillalt] (b\i) at (.25*\i,-.25*\i) {};
        \else
            \node[s=1.5cm, fill=tensorfill] (b\i) at (.25*\i,-.25*\i) {};
        \fi
    }
\end{scope}
%----------------------------------------
...
\foreach \i in {0,...,15} {
        \ifodd\i
            \node[s=1cm, fill=tensorfillalt] (c\i) at (.22*\i,-.22*\i) {};
        \else
            \node[s=1cm, fill=tensorfill] (c\i) at (.22*\i,-.22*\i) {};
        \fi
    }
\end{scope}
%----------------------------------------
...
\foreach \i in {0,...,15} {
        \ifodd\i
            \node[s=.6cm, fill=tensorfillalt] (d\i) at (.22*\i,-.22*\i) {};
        \else
            \node[s=.6cm, fill=tensorfill] (d\i) at (.22*\i,-.22*\i) {};
        \fi
    }
\end{scope}

\begin{scope}[xshift=16.7cm, yshift=-1.25cm]
\path[fill=tensorfillalt] (0,0)--coordinate[pos=0](l) coordinate[pos=1](m) ++(.7,0)
--coordinate[pos=1](n) ++(135:4) --coordinate[pos=1](o) ++(-.7,0)--cycle;
\end{scope}

\begin{scope}[xshift=18.2cm, yshift=-.9cm]
\path[fill=tensorfillalt] (0,0)--coordinate[pos=0](p) coordinate[pos=1](q) ++(.7,0)
--coordinate[pos=1](r) ++(135:3.25) --coordinate[pos=1](s) ++(-.7,0)--cycle;
\end{scope}

\begin{scope}[xshift=19.7cm, yshift=-.6cm]
\path[fill=tensorfillalt] (0,0)--coordinate[pos=0](t) coordinate[pos=1](u) ++(.7,0)
...
%------
\node[draw,tensoredge, very thin, s=.5cm] (1) at ($(0.center)+(.5,-.5)$) {};
\foreach \i in {north west,north east,south west,south east}
\draw[very thin,tensoredge] (1.\i)--coordinate[pos=.3](p1) ($(a5.center)+(.5,-.5)$);

\node[draw,,tensoredge, very thin, s=.25cm] (1) at ($(a5.center)+(-.5,.5)$) {};
\foreach \i in {north west,north east,south west,south east}
\draw[very thin,tensoredge] (1.\i)--coordinate[pos=.5](p2) ($(b5.center)+(-.35,.35)$);

\node[draw,,tensoredge, very thin, s=.5cm] (1) at ($(b5.center)+(.25,0.25)$) {};
\foreach \i in {north west,north east,south west,south east}
\draw[very thin,tensoredge] (1.\i)--coordinate[pos=.5](p3) ($(c15.center)+(.25,0.25)$);

\node[draw,,tensoredge, very thin, s=.25cm] (1) at ($(c15.center)+(-.25,-.25)$) {};
\foreach \i in {north west,north east,south west,south east}
\draw[very thin,tensoredge] (1.\i)--coordinate[pos=.4](p4) ($(d15.center)+(-.1,-.1)$);
