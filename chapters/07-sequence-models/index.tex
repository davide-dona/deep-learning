...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{chapters/07-sequence-models/tikz/show-and-tell.tex}}
...
\begin{figure}[H]
    \centering
    \input{chapters/07-sequence-models/tikz/show-attend-tell.tex}
...
\begin{itemize}
    ...
    To do this, it computes a set of attention weights $\alpha_{t,i}$ for each region $i$, conditioned on the decoder's previous hidden state $\vct{h}_{t-1}$ and the encoder's feature vectors $\vct{a}_i$.
...
\begin{figure}[H]
    \centering
    \input{chapters/07-sequence-models/tikz/rnn-attention.tex}
...
\begin{figure}[H]
    \centering
    \input{chapters/07-sequence-models/tikz/local-attention.tex}
...
\[
\alpha_{t,i} = \mathrm{softmax}(\vct{h}_i^\top \mat{W}_a \vct{s}_t) \cdot \exp\!\left(-\frac{(i - p_t)^2}{2\sigma^2}\right)
\]
...
\begin{figure}[H]
    \centering
    \input{chapters/07-sequence-models/tikz/local-vs-global.tex}
