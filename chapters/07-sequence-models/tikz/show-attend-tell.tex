\begin{tikzpicture}[
    >=Stealth,
    rnn/.style={rectangle, rounded corners=3pt, draw, fill=orange!75, thick,
                minimum width=1.2cm, minimum height=0.65cm},
    ctx/.style={rectangle, draw, fill=cyan!35, thick, minimum width=0.85cm, minimum height=0.6cm, font=\small},
    yin/.style={rectangle, draw, fill=green!18, thick, minimum width=0.85cm, minimum height=0.6cm, font=\small},
    pout/.style={rectangle, draw, fill=red!22, thick, minimum width=0.95cm, minimum height=0.6cm, font=\small},
    lbl/.style={font=\small},
    arr/.style={->, thick},
    grid3/.pic={\fill[yellow!22] (-0.3,-0.3) rectangle (0.3,0.3);
                \draw[step=0.2,thin] (-0.3,-0.3) grid (0.3,0.3);
                \draw[thin] (-0.3,-0.3) rectangle (0.3,0.3);}
]
    % ---- CNN + feature map ----
    \node[trapezium, trapezium angle=65, draw, fill=orange!75, thick,
    ...
    \draw[->, thick, magenta] (py1.south) to[out=-90,in=90] (y1.north);
\end{tikzpicture}
