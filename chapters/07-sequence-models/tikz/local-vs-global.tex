\begin{tikzpicture}[
    >=Stealth,
    enc/.style={rectangle, draw, fill=cyan!35, minimum width=0.4cm, minimum height=0.9cm, thick},
    dec/.style={rectangle, draw, fill=red!55, minimum width=0.4cm, minimum height=0.9cm, thick},
    ctx/.style={rectangle, draw, fill=cyan!55, minimum width=0.4cm, minimum height=1.0cm, thick},
    att/.style={rectangle, draw, fill=gray!30, minimum width=0.4cm, minimum height=1.0cm, thick},
...
\begin{scope}
    ...
    \node[draw=red!80!black, very thick, rounded corners, fit=(Le2)(Le3), inner sep=1.5mm] (Lwin) {};

    \node[ctx] (Lc) at (1.5,2.0) {};
    \node[lbl, left=4mm of Lc] {$c_t$};
    \node[att, minimum height=0.55cm, fill=gray!20] (La) at (2.7,1.25) {};
...
\begin{scope}[xshift=7.6cm]
    ...
    \node[att, minimum height=0.55cm, fill=gray!20] (Ga) at (3.0,1.25) {};
