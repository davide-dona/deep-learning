\begin{tikzpicture}[
    >=Stealth,
    rnn/.style={rectangle, rounded corners=3pt, draw, fill=orange!70, thick,
                minimum width=1.3cm, minimum height=0.65cm},
    clf/.style={rectangle, rounded corners=3pt, draw, fill=orange!55, thick,
                minimum width=1.3cm, minimum height=0.65cm, font=\small},
    word/.style={font=\small\itshape, text=teal!70!black},
    arr/.style={->, thick}
]
    % ---- CNN encoder ----
    \node[trapezium, trapezium angle=65, draw, fill=orange!70, thick,
