\begin{tikzpicture}[
    >=Stealth,
    enc/.style={rectangle, draw, fill=cyan!35, minimum width=0.5cm, minimum height=1.1cm, thick},
    dec/.style={rectangle, draw, fill=red!55, minimum width=0.5cm, minimum height=1.1cm, thick},
    ctx/.style={rectangle, draw, fill=cyan!55, minimum width=0.5cm, minimum height=1.2cm, thick},
    att/.style={rectangle, draw, fill=gray!30, minimum width=0.5cm, minimum height=1.2cm, thick},
    ...
    \node[draw=red!80!black, very thick, rounded corners, fit=(h2)(h4), inner sep=2.5mm] (win) {};
    ...
    % ---- Local weights ----
    \node[att, minimum height=0.75cm, fill=gray!20] (a) at (4.0, 1.7) {};
