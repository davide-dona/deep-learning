...
\begin{itemize}
    ...
    This branch is typically implemented as a small fully connected network that takes the aligned features from the RoIAlign layer and outputs a mask of fixed size for each class.
\end{itemize}