...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{chapters/08-sequence-models/tikz/show-and-tell.tex}}
...
\begin{figure}[H]
    \centering
    \input{chapters/08-sequence-models/tikz/show-attend-tell.tex}
...
\begin{figure}[H]
    \centering
    \input{chapters/08-sequence-models/tikz/rnn-attention.tex}
...
\begin{figure}[H]
    \centering
    \input{chapters/08-sequence-models/tikz/local-attention.tex}
...
\begin{figure}[H]
    \centering
    \input{chapters/08-sequence-models/tikz/local-vs-global.tex}
