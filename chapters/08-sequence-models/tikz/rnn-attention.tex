\begin{tikzpicture}[
    >=Stealth,
    enc/.style={rectangle, draw, fill=attncontext!70, thick, minimum width=0.8cm, minimum height=0.45cm, font=\small},
    dec/.style={rectangle, draw, fill=attnscore!85, thick, minimum width=0.7cm, minimum height=0.6cm, font=\small},
    ...
    \foreach \i/\x in {1/1, 2/2.3, 3/3.6, T/5.4} {
        ...
        \node[draw, dashed, dlgray, fit=(f\i)(b\i), inner sep=1.2mm] (col\i) {};
