...
\tikzset{
  IC/.style={draw=dlgray!55, fill=dlgray!25,
    minimum width=\S cm, minimum height=\S cm, inner sep=0},
  AC/.style={draw=kerneledge, fill=highlightfill!75,
    minimum width=\S cm, minimum height=\S cm, inner sep=0, line width=0.6pt},
  KC/.style={draw=kerneledge!90, fill=kernelfill,
    minimum width=\S cm, minimum height=\S cm, inner sep=0, line width=0.6pt},
  OC/.style={draw=dlgray!55, fill=dlgray!40,
    minimum width=\S cm, minimum height=\S cm, inner sep=0},
  OA/.style={draw=kerneledge, fill=highlightfill!60,
    minimum width=\S cm, minimum height=\S cm, inner sep=0, line width=0.6pt},
}
...
\node[font=\small, text=dlgray!80!black]  at (1.5, 0.62) {$5 \times 5$};
...
\node[font=\small, text=dlgray!80!black]  at (\KX+0.75, 0.62) {$3 \times 3$};

% Top horizontal
\draw[kerneledge!55, dashed, thin] (-\H, \H) -- (\KX-\H, \H);
% Bottom horizontal
\draw[kerneledge!55, dashed, thin] (-\H,-2*\S-\H) -- (\KX-\H,-2*\S-\H);
% Left vertical (RF side)
\draw[kerneledge!55, dashed, thin] (-\H, \H) -- (-\H,-2*\S-\H);
% Right vertical (kernel side)
\draw[kerneledge!55, dashed, thin] (\KX-\H, \H) -- (\KX-\H,-2*\S-\H);

\draw[-{Stealth[length=9pt]}, line width=1.8pt, color=kernelfill!85!black]
    (7.30, -\S) -- (8.05, -\S);
...
\node[font=\small, text=dlgray!80!black]  at (\OX+0.75, 0.62) {$3 \times 3$};
