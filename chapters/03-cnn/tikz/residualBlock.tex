...
\begin{tikzpicture}[
    node distance=0.9cm,
    layer/.style={draw, rounded corners, fill=kernelfill, minimum width=2.8cm, minimum height=0.8cm, font=\small},
    relu/.style={draw, rounded corners, fill=relufill, minimum width=2.8cm, minimum height=0.7cm, font=\small},
...
\draw[skip] (xtap) -- ++(3.0,0) coordinate (sk)
            |- (plus.east)
            node[skipcolor, midway, right, align=center, font=\small] {identity\\$x$} ;
