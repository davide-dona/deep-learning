\begin{tikzpicture}[
    kernelcell/.style={draw, fill=kernelfill, minimum width=1cm, minimum height=0.7cm, font=\large},
    inputcell/.style={draw, fill=dlgray!25, minimum width=1cm, minimum height=0.7cm, font=\large},
    outputcell/.style={draw, fill=dlgray!40, minimum width=1cm, minimum height=0.7cm, font=\large},
]
% Kernel row at y=2.5
...
\draw[-{Stealth[length=8pt]}, line width=1.5pt, color=kernelfill!80!black]
    (2.55, 2.5) -- (4.2, 2.5);  % kernel arrow
...
\draw[dlgray!70, thin] (-0.5, 2.15) -- (-0.5, 1.35);
\draw[dlgray!70, thin] (2.5,  2.15) -- (2.5,  1.35);
...
\draw[dlgray!70, thin] (-0.5, 0.65) -- (0.5, -0.05);
\draw[dlgray!70, thin] (7.5,  0.65) -- (6.5, -0.05);
