...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{chapters/07-expanding-cnn/tikz/rcnn-architecture.tex}}
...
\begin{itemize}
    ...
    \item \textbf{Classification Head}: The per-class SVMs of R-CNN are replaced with fully connected layers ending in a softmax classifier.
    Alongside it, a bounding box regressor is added, since the region proposals produced by Selective Search are only approximate and need to be refined to tightly fit the object.
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{chapters/07-expanding-cnn/tikz/fast-rcnn-architecture.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{chapters/07-expanding-cnn/tikz/faster-rcnn-architecture.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{chapters/07-expanding-cnn/tikz/mask-rcnn-architecture.tex}}
