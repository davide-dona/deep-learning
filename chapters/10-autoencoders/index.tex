...
\begin{figure}[H]
    \centering
    \resizebox{0.6\textwidth}{!}{\input{chapters/10-autoencoders/tikz/autoencoder-architecture.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{0.5\textwidth}{!}{\input{chapters/10-autoencoders/tikz/vae-architecture.tex}}
