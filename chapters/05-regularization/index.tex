...
This section explores the most common approaches applied to FFNNs.
...
such as CNNs, which also rely on their own domain-specific regularization mechanisms.
...
\begin{figure}[H]
    \centering
    \input{chapters/05-regularization/tikz/multi-task-learning.tex}
...
The prime example is the \textbf{CNN}, which applies a single, shared set of weights (a filter) across all spatial locations of an input. 
...
\begin{figure}[H]
    \centering
    \input{chapters/05-regularization/tikz/dropout.tex}
...
Some techinques, such as SGD, have been shown to have an implicit regularization effect on the model.
